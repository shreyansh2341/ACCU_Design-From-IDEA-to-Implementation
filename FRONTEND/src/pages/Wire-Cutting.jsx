...
const WireCuttingPage = () => {
  return (
    <div className="w-full overflow-x-hidden">
          {/* Header Section */}
          <section className="w-full h-[46vh] bg-[url('https://res.cloudinary.com/dxrryep5y/image/upload/v1753296110/website_static_media/wire_cutting2.png')] bg-cover bg-center bg-black bg-opacity-70 bg-blend-darken flex items-center justify-center">
          ...
          <div className="w-full flex flex-col-reverse md:flex-row justify-evenly flex-wrap mt-5 px-4">
            ...
            <div className="w-full md:w-[55%] p-5 flex flex-col items-start">
              <img
                src="https://res.cloudinary.com/dxrryep5y/image/upload/v1753296098/website_static_media/wire_cutting.png"
                alt="Casting"
              ...
              />
              <h2 className="text-2xl font-bold ml-2 mb-2">Wire Cutting</h2>
              <p className="text-justify mb-4 ml-3 text-lg">
                Wire Cutting Our Wire Cutting Services Deliver Precise, Efficient Solutions With Minimal Waste, Contributing To Cost Savings And Sustainability In Your Projects.</p>
              {/* Services Section */}
              <h2 className="text-xl font-bold ml-2 mb-2">Services:</h2>
              <ul className="list-disc ml-6 mb-5 text-lg">
              <li>EDM Wire Cutting (Electro-Discharge Machining)</li>
              <li>Fine Wire Cutting For Intricate Designs</li>
              <li>High-Speed Cutting For Thick Materials</li>
              <li>Prototype Component Cutting</li>
              </ul>
...
export default WireCuttingPage;
