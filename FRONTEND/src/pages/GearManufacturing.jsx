...
const features = [
  "Custom-Designed gears for diverse industries",
  "High-precision CNC machining & grinding",
  "ISO 9001:2015 certified manufacturing",
  "Prototyping to high-volume production",
  "Support for spur, helical, bevel, worm, and more",
];
...
const processes = [
  {
    title: "Spur Gears",
    description:
      "Straight-tooth gears for simple, efficient power transmission in parallel shafts.",
    image: "https://res.cloudinary.com/dxrryep5y/image/upload/v1753295754/website_static_media/surp.jpg",
  },
  {
    title: "Helical Gears",
    description:
      "Angled teeth for smooth and quiet operation under higher loads.",
    image: "https://res.cloudinary.com/dxrryep5y/image/upload/v1753295684/website_static_media/helical.jpg",
  },
  {
    title: "Bevel & Worm Gears",
    description:
      "For right-angle and high-reduction applications with compact Design.",
    image: "https://res.cloudinary.com/dxrryep5y/image/upload/v1753295638/website_static_media/bevel.jpg",
  },
];

const GearManufacturing = () => {
  return (
    <div>
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 text-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-28 text-center">
          <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight bg-gradient-to-r from-cyan-400 to-blue-300 bg-clip-text text-transparent animate-pulse">
            Precision Gear Manufacturing Solutions
          </h1>
          <p className="mt-6 text-lg md:text-xl max-w-3xl mx-auto text-blue-100">
            ...
            craft high-precision gears to power your machinery with accuracy, efficiency, and durability.
          </p>
          <div className="mt-8">
            <SLink
              to="/get-quote"
      ...
      <section className="bg-gray-50 py-12">
        <h2 className="text-3xl font-bold text-center mb-8">
          Why Choose ACCU DESIGN for Gear Manufacturing?
        </h2>
      ...
      <section className="py-12 px-4">
        <h2 className="text-3xl font-bold text-center mb-8">
          Our Gear Manufacturing Capabilities
        </h2>
      ...
      <section className="bg-blue-600 text-white text-center py-16">
        <h2 className="text-3xl md:text-4xl font-bold mb-4">
          Power Your Machines with Precision Gears
        </h2>
        <p className="mb-6 text-lg">
          Contact Accu Design today for reliable, custom gear manufacturing services tailored to your needs.
        </p>
        <SLink
          to="/contact-us"
...
export default GearManufacturing;
