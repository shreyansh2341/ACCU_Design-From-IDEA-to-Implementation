  ...
  return (
    <div>
      <div className="w-full overflow-x-hidden">
        {/* Header Section */}
        <section className="w-full h-[46vh] bg-[url('https://res.cloudinary.com/dxrryep5y/image/upload/v1753295790/website_static_media/bending2.png')] bg-cover bg-center bg-black bg-opacity-70 bg-blend-darken flex items-center justify-center">
          <div className="text-white text-center text-2xl md:text-4xl font-semibold">Bending</div>
        </section>
        {/* Main Container */}
        <div className="w-full flex flex-col-reverse md:flex-row justify-evenly flex-wrap mt-5 px-4">
          ...
          <div className="w-full md:w-[55%] p-5 flex flex-col items-start">
            <img
              src="https://res.cloudinary.com/dxrryep5y/image/upload/v1753295786/website_static_media/bending.png"
              alt="Casting"
            ...
            />
            <h2 className="text-2xl font-bold ml-2 mb-2">Bending</h2>
            <p className="text-justify mb-4 ml-3 text-lg">
              Our Bending Services Deliver Precise, Efficient Solutions That Reduce Waste And Enhance Sustainability While Maintaining High-Quality Results.</p>

            {/* Services Section */}
            <h2 className="text-xl font-bold ml-2 mb-2">Services:</h2>
            <ul className="list-disc ml-6 mb-5 text-lg">
              <li>Hydraulic Press Bending</li>
              <li>V-Bending (Air Bending)</li>
              <li>U-Bending</li>
              <li>Rotary Bending</li>
              <li> Custom Angle Forming</li>
            </ul>
