...
const features = [
  "High-precision laser cutting for metals & non-metals",
  "Advanced CNC-controlled cutting systems",
  "Clean edges & minimal material waste",
  "Fast turnaround for prototypes & production",
  "Custom solutions for intricate designs",
];
...
const processes = [
  {
    ...
    description:
      "Efficient and precise cutting of metals like steel, aluminum, and copper with minimal heat distortion.",
    image: "https://res.cloudinary.com/dxrryep5y/image/upload/v1753339728/website_static_media/fiber-laser.jpg",
  },
  {
    title: "CO₂ Laser Cutting",
    description:
      "Ideal for cutting and engraving non-metals such as plastics, wood, and acrylic.",
    image: "https://res.cloudinary.com/dxrryep5y/image/upload/v1753339715/website_static_media/co2-laser.jpg",
  },
  {
    title: "Precision Micro Cutting",
    description:
      "For ultra-fine details and complex geometries in thin materials.",
    image: "https://res.cloudinary.com/dxrryep5y/image/upload/v1753339745/website_static_media/micro-laser.jpg",
  },
];

const LaserCuttingServices = () => {
  return (
    <div>
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 text-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-28 text-center">
          ...
          <p className="mt-6 text-lg md:text-xl max-w-3xl mx-auto text-blue-100">
            At <span className="font-semibold text-cyan-300">ACCU Design</span>, we deliver clean, accurate, and fast laser-cut parts for your most demanding projects.
          </p>
          <div className="mt-8">
            <SLink
              to="/get-quote"
      ...
      <section className="bg-gray-50 py-12">
        <h2 className="text-3xl font-bold text-center mb-8">
          Why Choose ACCU DESIGN for Laser Cutting?
        </h2>
      ...
      <section className="bg-blue-600 text-white text-center py-16">
        <h2 className="text-3xl md:text-4xl font-bold mb-4">
          Let’s Cut with Precision and Speed
        </h2>
        <p className="mb-6 text-lg">
          Contact Accu Design for your next laser cutting project — we guarantee accuracy and efficiency.
        </p>
        <SLink
          to="/contact-us"
...
export default LaserCuttingServices;
