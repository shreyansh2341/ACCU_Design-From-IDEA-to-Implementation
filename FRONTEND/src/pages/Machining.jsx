...
const MachiningPage = () => {
  return (
    <div className="w-full overflow-x-hidden">
      {/* Header Section */}
      <section className="w-full h-[46vh] bg-[url('https://res.cloudinary.com/dxrryep5y/image/upload/v1753295707/website_static_media/machining1.png')] bg-cover bg-center bg-black bg-opacity-70 bg-blend-darken flex items-center justify-center">
      ...
      <div className="w-full flex flex-col-reverse md:flex-row justify-evenly flex-wrap mt-5 px-4">
        ...
        <div className="w-full md:w-[55%] p-5 flex flex-col items-start">
          ...
          <ul className="list-disc ml-6 mb-5 text-lg">
            <li>CNC Machining - Turning, Drilling</li>
            <li>VMC Machining - Milling, Drilling</li>
