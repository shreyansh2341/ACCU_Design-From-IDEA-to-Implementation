...
const fabrication = () => {
  return (
    <div className="w-full overflow-x-hidden">
      {/* Header Section */}
      <section className="w-full h-[46vh] bg-[url('https://res.cloudinary.com/dxrryep5y/image/upload/v1753295805/website_static_media/fabrication1.png')] bg-cover bg-center bg-black bg-opacity-70 bg-blend-darken flex items-center justify-center">
      ...
      <div className="w-full flex flex-col-reverse md:flex-row justify-evenly flex-wrap mt-5 px-4">
        ...
        <div className="w-full md:w-[55%] p-5 flex flex-col items-start">
          ...
          <h2 className="text-2xl font-bold ml-2 mb-2"> Fabrication</h2>
          <p className="text-justify mb-4 ml-3 text-lg">
            We Can Provide You With A Range Of Solutions To Save Money And Enhance Operational Efficiency While Reducing Your Environmental Impact.</p>
          {/* Services Section */}
          ...
          <ul className="list-disc ml-6 mb-5 text-lg">
            ...
            <li>Aluminum Frame Assembly</li>
            <li>Heavy-Duty Frame Welding</li>
            <li>Customized Product Assembly</li></ul>
