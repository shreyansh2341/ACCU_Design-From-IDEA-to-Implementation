...
const features = [
  "High-precision EDM wire cutting technology",
  "Capability to cut hard metals and intricate shapes",
  "Superior surface finish and tight tolerances",
  "No mechanical stress or deformation on parts",
  "Expert support from prototype to production",
];
...
const processes = [
  {
    ...
    description:
      "Electrical discharge machining with fine wires for extreme precision and complex profiles.",
    image: "/images/edm-wire-cutting.jpg",
  },
  {
    title: "Micro Wire Cutting",
    description:
      "Ideal for extremely small components with micron-level accuracy.",
    image: "/images/micro-wire-cutting.jpg",
  },
  {
    title: "Taper Wire Cutting",
    description:
      "Cutting at precise angles for special geometries and dies.",
    image: "/images/taper-wire-cutting.jpg",
  },
];

const WireCuttingServices = () => {
  return (
    <div>
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 text-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-28 text-center">
          <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight bg-gradient-to-r from-cyan-400 to-blue-300 bg-clip-text text-transparent animate-pulse">
            High-Precision Wire Cutting Services
          </h1>
          <p className="mt-6 text-lg md:text-xl max-w-3xl mx-auto text-blue-100">
            At <span className="font-semibold text-cyan-300">ACCU DESIGN</span>, we deliver exceptional accuracy and quality in wire EDM cutting for your most demanding projects.
          </p>
          <div className="mt-8">
            <SLink
              to="/get-quote"
      ...
      <section className="bg-gray-50 py-12">
        <h2 className="text-3xl font-bold text-center mb-8">
          Why Choose ACCU DESIGN for Wire Cutting?
        </h2>
      ...
      <section className="bg-blue-600 text-white text-center py-16">
        <h2 className="text-3xl md:text-4xl font-bold mb-4">
          Intricate Cuts, Impeccable Quality
        </h2>
        <p className="mb-6 text-lg">
          Contact Accu DESIGN today for precise and reliable wire EDM cutting services.
        </p>
        <SLink
          to="/contact-us"
...
export default WireCuttingServices;
