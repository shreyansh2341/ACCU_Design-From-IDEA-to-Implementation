     ...
     {/* Header Section */}
      ...
      <div className="w-full flex flex-col-reverse md:flex-row justify-evenly flex-wrap mt-5 px-4">
        ...
        <div className="w-full md:w-[55%] p-5 flex flex-col items-start">
          ...
          />
          <h2 className="text-2xl font-bold ml-2 mb-2">Gear Manufacturing</h2>
          <p className="text-justify mb-4 ml-3 text-lg">
            We Specialize In High-Precision Gear Manufacturing, Offering Cost-Effective Solutions That Minimize Waste And Support Sustainable Production.
          </p>
          {/* Services Section */}
          <h2 className="text-xl font-bold ml-2 mb-2">Services:</h2>
          <ul className="list-disc ml-6 mb-5 text-lg">
            <li>FSpur Gear Production</li>
            <li>Helical Gear Cutting</li>
            <li> Bevel Gear Manufacturing</li>
            <li> Gearbox Refurbishing</li>
            <li> Spline And Shaft Machining</li>
          </ul>
...
export default GearManufacturingPage;
