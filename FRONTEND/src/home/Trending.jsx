...
//       <h1 className="text-3xl font-bold mb-6 text-center text-[#2479C2]">Trending</h1>
//       <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
//         {blogs && blogs.length > 0 ? (
//           blogs.slice(0, 6).map((element) => (
//             <div
//               key={element._id}
//               className="group bg-white rounded-xl shadow-md hover:shadow-xl overflow-hidden transform hover:scale-105 transition duration-300 ease-in-out h-[440px] flex flex-col relative"
//             >
//               {/* Image */}
...
const Trending = () => {
  ...
  return (
    <div className="ml-6 w-full px-4 py-8 transition-all duration-300">
      <h1 className="text-3xl font-bold mb-6 text-center text-[#2479C2]">
        Trending
      </h1>
          ...
          blogs.slice(0, 6).map((element) => (
            <SLink
              ...
              className="group bg-white/90 backdrop-blur-sm rounded-2xl border border-blue-50 
                         ...
                         transition-all duration-300 ease-out h-[440px] flex flex-col relative overflow-hidden"
            >
              {/* Category Tag */}
              ...
              {/* Blog About Preview */}
              <div className="px-4 pb-3 pt-1 text-gray-700 text-sm">
